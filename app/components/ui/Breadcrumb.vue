    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li v-for="(item, index) in items" :key="index" aria-current="page">
        <div class="flex items-center">
          ...
          <NuxtLink v-if="item.href" :to="item.href" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">
            {{ item.name }}
          </NuxtLink>
